...
<?php
    ...
    function process_admin_this_plugin() {
        ...
        function admin_custom_style() {
            ...
            wp_enqueue_style( 'admin-custom-style',  plugins_url( 'assets/css/admin-style.css', __FILE__  ), '', $plugin_ver , true );
        }
        ...
        function admin_custom_enqueue($hook) {
            ...
            */
            wp_enqueue_script( 'admin-custom-script', plugins_url( 'assets/js/admin-script.js', __FILE__  ), '', $plugin_ver , true );
        }
